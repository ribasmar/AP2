...
public interface GyhLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GyhLangParser#listaDeclaracoes2}.
	 * @param ctx the parse tree
	 */
	void enterListaDeclaracoes2(GyhLangParser.ListaDeclaracoes2Context ctx);
	/**
	 * Exit a parse tree produced by {@link GyhLangParser#listaDeclaracoes2}.
	 * @param ctx the parse tree
	 */
	void exitListaDeclaracoes2(GyhLangParser.ListaDeclaracoes2Context ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GyhLangParser#expressaoAritmetica2}.
	 * @param ctx the parse tree
	 */
	void enterExpressaoAritmetica2(GyhLangParser.ExpressaoAritmetica2Context ctx);
	/**
	 * Exit a parse tree produced by {@link GyhLangParser#expressaoAritmetica2}.
	 * @param ctx the parse tree
	 */
	void exitExpressaoAritmetica2(GyhLangParser.ExpressaoAritmetica2Context ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GyhLangParser#termoAritmetico2}.
	 * @param ctx the parse tree
	 */
	void enterTermoAritmetico2(GyhLangParser.TermoAritmetico2Context ctx);
	/**
	 * Exit a parse tree produced by {@link GyhLangParser#termoAritmetico2}.
	 * @param ctx the parse tree
	 */
	void exitTermoAritmetico2(GyhLangParser.TermoAritmetico2Context ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GyhLangParser#expressaoRelacional2}.
	 * @param ctx the parse tree
	 */
	void enterExpressaoRelacional2(GyhLangParser.ExpressaoRelacional2Context ctx);
	/**
	 * Exit a parse tree produced by {@link GyhLangParser#expressaoRelacional2}.
	 * @param ctx the parse tree
	 */
	void exitExpressaoRelacional2(GyhLangParser.ExpressaoRelacional2Context ctx);
	/**
